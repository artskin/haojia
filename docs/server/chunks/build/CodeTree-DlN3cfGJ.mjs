import { useSlots, computed, ref, watch, unref, withCtx, defineComponent, createVNode, createBlock, createCommentVNode, openBlock, toDisplayString, Fragment, renderList, mergeProps, resolveDynamicComponent, shallowRef, withModifiers, withKeys, renderSlot, toRefs, nextTick, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrRenderList, ssrRenderAttr, ssrRenderClass, ssrInterpolate, ssrRenderAttrs, ssrRenderVNode } from 'vue/server-renderer';
import { h as useAppConfig, k as tv, l as _sfc_main$g, F as makeDestructurable, g as createContext, C as useCollection, P as Primitive, e as useVModel, E as createEventHook, G as camelize, B as getActiveElement, D as refAutoReset } from './server.mjs';
import { u as useDirection } from './useDirection-MM1HLa6H.mjs';
import { a as RovingFocusItem_default, R as RovingFocusGroup_default, M as MAP_KEY_TO_FOCUS_INTENT } from './RovingFocusItem-Cjzc3o3P.mjs';
import _sfc_main$1 from './CodeIcon-CBoa-Mr4.mjs';
import { J as isEqual } from '../nitro/nitro.mjs';
import 'vue-router';
...
const _sfc_main = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    const [DefineTreeTemplate, ReuseTreeTemplate] = /* @__PURE__ */ createReusableTemplate();
          ...
          if (_push2) {
            ...
            ssrRenderList(items2, (item, index) => {
              _push2(ssrRenderComponent(unref(TreeItem_default), {
                ...
                default: withCtx(({ isExpanded, isSelected }, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<button type="button"${ssrRenderAttr("data-expanded", isExpanded)} class="${ssrRenderClass(ui.value.link({ class: props.ui?.link, active: isSelected }))}"${_scopeId2}>`);
            ...
            return [
              (openBlock(true), createBlock(Fragment, null, renderList(items2, (item, index) => {
                return openBlock(), createBlock(unref(TreeItem_default), {
                  key: `${level}-${index}`,
                  level,
                  value: item,
                  class: level > 1 ? ui.value.itemWithChildren({ class: props.ui?.itemWithChildren }) : ui.value.item({ class: props.ui?.item })
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.0.1_@babel+parser@7.28.4_db0@0.3.4_better-sqlite3@12.4.1__embla-carousel@8.6_ed4761438fe2494b20730fc024b14980/node_modules/@nuxt/ui/dist/runtime/components/prose/CodeTree.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=CodeTree-DlN3cfGJ.mjs.map
