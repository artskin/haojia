import { c as useAsyncData, d as useSeoMeta, a as __nuxt_component_0$2, t as tryUseNuxtApp, b as useRuntimeConfig } from './server.mjs';
import { defineComponent, withAsyncContext, withCtx, createTextVNode, unref, computed, toRaw, mergeProps, resolveComponent, defineAsyncComponent, h, getCurrentInstance, reactive, watch, Text, Comment, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrRenderSlot } from 'vue/server-renderer';
import { H as pascalCase, I as kebabCase, t as withoutTrailingSlash, f as destr } from '../nitro/nitro.mjs';
...
_sfc_main$2.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxtjs+mdc@0.17.4_magicast@0.3.5/node_modules/@nuxtjs/mdc/dist/runtime/components/MDCRenderer.vue");
...
const virtual_nuxt__2FUsers_2Fartskin_2Fwww_2Fartskin_2Fhaojia_2Fdocs_2Fnode_modules_2F_cache_2Fnuxt_2F_nuxt_2Fcontent_2Fcomponents = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  globalComponents,
  localComponents
}, Symbol.toStringTag, { value: "Module" }));
    ...
    function resolveVueComponent(component) {
      ...
      if (typeof component === "string") {
        ...
        if (globalComponents.includes(pascalCase(component))) {
          ...
          const loader = () => {
            return Promise.resolve().then(() => virtual_nuxt__2FUsers_2Fartskin_2Fwww_2Fartskin_2Fhaojia_2Fdocs_2Fnode_modules_2F_cache_2Fnuxt_2F_nuxt_2Fcontent_2Fcomponents).then((m) => {
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+content@3.7.1_better-sqlite3@12.4.1_magicast@0.3.5/node_modules/@nuxt/content/dist/runtime/components/ContentRenderer.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const __nuxt_component_1 = Object.assign(_sfc_main$1, { __name: "ContentRenderer" });
const checksums = {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: home } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(() => queryCollection("content").path("/").first(), "$QD8d9NkvSp")), __temp = await __temp, __restore(), __temp);
    useSeoMeta({
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><header><nav><ul><li>`);
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/haojia" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`好价商品`);
          } else {
            return [
              createTextVNode("好价商品")
            ];
          }
        }),
        _: 1
      ...
      if (unref(home)) {
        _push(ssrRenderComponent(_component_ContentRenderer, { value: unref(home) }, null, _parent));
      } else {
        _push(`<div>首页未找到</div>`);
      }
      _push(`<!--]-->`);
...
//# sourceMappingURL=index-B6iT8LNe.mjs.map
